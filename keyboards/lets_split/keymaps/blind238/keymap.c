 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |Adjust| GUI  | Alt  |Lower |Space |Space |Raise | Nav  |      | Vol- | Vol+ |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = KEYMAP( \
  ...
  KC_LCTL, ADJUST,  KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   NAV,     XXXXXXX, KC_VOLD, KC_VOLU \
),
...
[_LOWER] = KEYMAP( \
  ...
  KC_DEL,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
